    ...
    <Layout listOfTags={listTags} mostSeen={mostSeen}>
      <div className={Style.about}>
        ...
        <p className={Style.about_shortDescription}>
          ...
          Soy un desarrollador de software capaz de llevar una aplicación de
          inicio a fin, con conocimientos en <b>Frontend</b>, <b>Backend</b>,{" "}
          <b>Móvil</b>, <b>Google Play</b>, <b>Google Cloud Platform</b>, ...{" "}
